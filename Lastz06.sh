...
# LASTZ
        ...
        seq ${STARTVALUE} ${ENDVALUE} | parallel lastz '~/Genomes/'${GENOME}'/Split_seqs/seq{}.fa[unmask,multiple] ~/Run06/Lastz/Query06.fasta[unmask,multiple] --chain --gapped --coverage=80 --ambiguous=n --ambiguous=iupac --format=general-:name2,start2,end2,score,strand2,size2,name1,start1,end1 > ~/Run06/Lastz/Results/'${GENOME}'/Hits/LASTZ_CR1_'${GENOME}'_seq{}'

        # Make sure you are in the right directory
        cd ~/Run06/Lastz/Results/${GENOME}/Hits
